...
<body>
	<b>아이디 찾기</b><br>
	<button onclick="location.href='/BetterHip/login/findId.jsp'">아이디 찾기</button> <button onclick="location.href='/BetterHip/login/findPw.jsp'">비밀번호 찾기</button><br>
	<form action="findId.do" name="findId">
		...
		<input type="button" value="아이디 찾기" onclick="find()"><br>
	</form>
</body>
</html>